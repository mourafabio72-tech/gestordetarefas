...
[2026-09-09T15:10:00] fase=15 acao=excecao_por_obrigacao_empresa resultado=ok obs="Tabela ObrigacaoExcecao (obrigacao, empresa, motivo, quem, quando), SEPARADA da obrigacao_empresa. O motivo nao e estetico: aquela alimenta o relationship Obrigacao.empresas, que significa INCLUSAO, e uma coluna 'excluida' ali faria o mesmo relationship devolver inclusao e exclusao misturadas -- empresas_alvo() passaria a somar quem deveria subtrair, em silencio. empresas_alvo() subtrai nos DOIS modos de alvo: so no modo 'regra' deixaria a decisao furada, porque bastaria a obrigacao mudar de modo para a empresa voltar a gerar sem ninguem desfazer nada."

[2026-09-09T15:12:00] fase=15 acao=reuso_do_cancelada resultado=ok obs="A tarefa desconsiderada reusa o status CANCELADA, com um campo proprio dizendo que foi decisao e nao desistencia, mais motivo, autor e data. Status novo exigiria ALTER TYPE no enum nativo do Postgres, que e risco sem ganho (degrau 2 da Escada). O reuso pagou na hora: o _situacao() do painel ja separava CANCELADA de pendente e atrasada, entao o item 'nao conta como pendente nem atrasada' veio de graca, e a prova so precisou confirmar -- com o prazo VENCIDO de proposito, senao o caso passaria sem provar nada."

[2026-09-09T15:30:00] fase=15 acao=verificacao_adversarial resultado=ok obs="Verificador de contexto limpo achou CINCO defeitos, todos meus, todos desta fase, e todos corrigidos. (1) FK sem ondelete: apagar a obrigacao de vez estourava FOREIGN KEY (500) no Postgres, ou deixava linha orfa no SQLite; fechado com ondelete=CASCADE nas duas pontas, que tambem cobre apagar a empresa. (2) CORRIDA real, provada com duas threads pelo verificador: 'olha se existe' e 'insere depois' nao e atomico, e duas tarefas da MESMA obrigacao e empresa (competencias diferentes) marcadas ao mesmo tempo derrubavam a segunda com 500 na unique; agora o INSERT vai num begin_nested e quem perde a corrida ja tem o que queria. (3) O e-validador dava baixa em tarefa CANCELADA: um documento chegando depois REVERTIA em silencio a decisao que uma pessoa escreveu, concluindo trabalho que ela disse que nao era daquele cliente; agora recusa com explicacao. (4) gerar_para_empresa nao subtraia as excecoes. (5) A propria prova rodava sem PRAGMA foreign_keys=ON e por isso nao via nada disso: ligado, e ela ganhou os casos correspondentes."

[2026-09-09T15:32:00] fase=15 acao=achado_menor_registrado resultado=ok obs="Nao corrigido, com o motivo: chamar a acao duas vezes na MESMA tarefa reescreve motivo, autor e data em vez de recusar. O verificador apontou como falta de idempotencia. Fica assim de proposito: corrigir o texto do motivo e um uso legitimo, e a excecao em si ja e idempotente pela unique. O que nao pode, e nao acontece, e estourar erro."

[2026-09-09T16:00:00] fase=16 acao=alvo_vira_maquina resultado=ok obs="O alcance da obrigacao saiu do JSX para pages/alvoObrigacao.js. Os dois buracos medidos na fase 8 fecharam: (a) o check 'aplicar a todas' era DERIVADO de !regimes && !segmentos, entao ficava marcado com dez empresas vinculadas em 'somente estas', dizendo o contrario do que a tela fazia; agora ele e estado de tela, e vincular a PRIMEIRA empresa desmarca sozinho e poe alvo_modo=vinculadas; (b) desmarcar o check FORCAVA o primeiro regime da lista, entao a obrigacao passava a valer para um perfil que ninguem pediu, e nao havia caminho por ali para 'so estas empresas'. Desvincular a ultima empresa devolve o modo E o perfil que havia antes, senao a obrigacao fica presa em 'vinculadas' com lista vazia, que nao gera para ninguem em silencio."

[2026-09-09T16:05:00] fase=16 acao=conferencia_visual resultado=ok obs="Feita por mim, app rodando local. Marcar a primeira empresa: o radio pulou para 'Somente estas' e o check sumiu, dando lugar ao aviso ambar que explica que ele saiu sozinho e como faze-lo voltar. Desmarcar a unica empresa: o check voltou marcado e o radio voltou para 'Somar ao perfil'. Confirmado de passagem o resultado da fase 13: o campo 'Responsavel padrao' nao existe mais no cadastro da obrigacao. Servidores locais encerrados."

[2026-09-09T16:08:00] fase=16 acao=fase_fechada resultado=ok obs="prova_alvo_check.js com 15 casos passa, entre eles o que compara o que a TELA mostra com o que vai para a API e exige que concordem. prova_alvo_vinculadas.py segue passando. 24 provas do backend, 17 do frontend, build sem erro. Fase 16 = done. Falta so a fase 17, de entrega."

[2026-09-09T16:30:00] fase=17 acao=entrega_menos_o_push resultado=ok obs="Fechados os quatro itens que nao dependem de publicar: matriz de conformidade com ZERO linha pendente (15 ok, 2 desvio declarado, 1 parcial com o alcance escrito), inventario da escada com ZERO marcadores, graphify update (1480 nos e 3319 arestas, contra 1336 e 2977 na abertura), e as duas specs do projeto atualizadas. Nove commits prontos, nenhum publicado: producao responde build 20260903-1730, de seis dias atras."

[2026-09-09T16:35:00] fase=17 acao=risco_do_deploy_medido resultado=blocked obs="PAREI ANTES DO PUSH, de proposito, e o motivo nao e o schema. As migracoes sao aditivas e idempotentes (duas tabelas novas pelo create_all, quatro colunas e dois indices pelo migrate), entao subir nao quebra o que esta la. O que muda de COMPORTAMENTO e a fase 13: a tarefa deixa de herdar o responsavel da obrigacao. Em producao, toda empresa que nao tiver a matriz (empresa, setor) preenchida vai gerar tarefa SEM dono a partir do proximo mes. Antes isso ficava mascarado pelo fallback. O scheduler gera sozinho no dia 1 as 6h (scheduler.py:101), e hoje e 09/09: ha tres semanas de margem para preencher a matriz, e a resposta da geracao passou a dizer quantas e quais empresas ficariam assim. Publicar um app que o escritorio usa, com uma mudanca dessas, e decisao do Fabio e nao minha, mesmo com o plano aprovado prevendo o deploy nesta fase."

[2026-09-09T17:10:00] fase=17 acao=publicado resultado=ok obs="O usuario mandou publicar. Push dos 10 commits (e6f8d4e..ef50124). O deploy levou cerca de 8 minutos, e nao os ~2 de costume, o que nao e sinal de nada: e um Compose com dois servicos e build do frontend. Carimbo de producao 20260909-1125, igual ao do HEAD."

[2026-09-09T17:12:00] fase=17 acao=provado_pelo_conteudo resultado=ok obs="O carimbo diz que a IMAGEM e nova, e nao que o codigo desta rodada entrou nela -- e a licao do broker, registrada no CLAUDE.md do workspace. Entao perguntei pelas ROTAS: sem token, POST /api/tarefas/0/nao-se-aplica responde 401 e GET /api/obrigacoes/0/excecoes responde 401. Rota inexistente responderia 404, entao o 401 prova que o codigo novo esta servindo, e nao so que a imagem trocou."

[2026-09-09T17:15:00] fase=17 acao=projeto_fechado resultado=ok obs="As nove fases (9 a 17) em done. 44 arquivos, 3979 linhas a mais e 173 a menos. 24 provas no backend e 17 no frontend, todas rc=0, sendo 6 e 2 novas desta rodada, com 146 casos ao todo nas oito provas novas. Matriz de conformidade sem linha pendente. Zero marcadores 'escada:'. O QUE FICA PENDENTE PARA O USUARIO, e nao e codigo: preencher a matriz (empresa, setor) das empresas que ainda nao tem responsavel cadastrado. A partir de agora a tarefa nao herda mais o responsavel da obrigacao, e o scheduler gera o mes no dia 1 as 6h; a resposta da geracao diz quantas nasceram sem dono e de quais empresas."
